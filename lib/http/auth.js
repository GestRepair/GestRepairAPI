...
module.exports = function(req, res, next) {
  ...
  dbsql.mysql.getConnection(function(err, connection) {
    ...
    connection.query('select tu.idUser, tu.username, tu.password, tu.name, tu.street,tu.zipcode, tu.city, tu.email, tu.nif, tu.contact, tr.nameRole from tbl_user tu, tbl_role tr WHERE tu.role = tr.idRole and tu.username =  ? ', login.name, function(error, results, fields) {
      connection.release();
