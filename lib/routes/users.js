...
exports.listEmployer = function(req, res) {
  dbsql.mysql.getConnection(function(err, connection) {
    var id = req.params.id;
    connection.query('select e.idEmployer,u.name,s.nameService as service  from tbl_employer e, tbl_user u,tbl_service s where u.idUser = e.user and s.idService = e.service and e.isActive = ?;',id, function(error, results, fields) {
      connection.release();
...
exports.listEmployerService = function(req, res) {
  dbsql.mysql.getConnection(function(err, connection) {
    ...
    connection.query('select e.idEmployer,u.name from tbl_employer e, tbl_user u where u.idUser = e.user and e.isActive = ? and e.service = ?;',[id,service], function(error, results, fields) {
      connection.release();
