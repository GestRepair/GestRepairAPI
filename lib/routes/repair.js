...
exports.listStates = function (req, res) {
  dbsql.mysql.getConnection(function (err, connection) {
    connection.query('SELECT sr.* FROM tbl_repair r, tbl_state_repair sr where r.state = sr.idstate group by sr.idstate;', function (error, results, fields) {
      connection.release();
...
exports.listStatesComplete = function (req, res) {
  dbsql.mysql.getConnection(function (err, connection) {
