...
module.exports = function(req, res, next) {
  ...
  dbsql.mysql.getConnection(function(err, connection) {
    ...
    connection.query('select tu.numUtilizador, tu.username, tu.password, tu.nome, tu.morada,tu.codPostal, tu.localidade, tu.email, tu.nif, tu.contacto, tr.nameRole from tbl_utilizadores tu, tbl_role tr WHERE tu.role = tr.idRole and tu.username =  ? ', login.name, function(error, results, fields) {
      connection.release();
