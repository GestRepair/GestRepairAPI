...
exports.list = function(req, res) {
  dbsql.mysql.getConnection(function(err, connection) {
    ...
    connection.query('SELECT ut.numUtilizador,ut.username,ut.nome,ut.morada,ut.codPostal,ut.localidade,ut.email,ut.nif,ut.contacto,isActive,ro.nomeRole FROM tbl_utilizadores ut INNER JOIN tbl_roles_utilizador ro ON ut.role = ro.idRole;', function(error, results, fields) {
      connection.release();
