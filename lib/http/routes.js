...
module.exports = function (app) {
   ...
   * Service
   */
  app.get('/service/parts/:id', routes.parts.listPartService);
  ...
  app.get('/service/desk/:id', routes.service.infoDesk);
   ...
   * Budget
   */
  app.get('/budget/service/not/:id', auth, routes.budget.listServiceWhith);
  ...
  app.get('/parts/service/whith', auth, routes.parts.listServiceWhithPart);
